...
function About() {
  return (
    <Container>
      ...
      <br />
      <Paragraph>
        I created this application as assessment assignment for Relatics. I have
        chosen to use React with Javascript as framework and language because
        these are both currently in use at Relatics.
      </Paragraph>
      <br />
      ...
      <Paragraph>
        ...
        styles in their applications.
      </Paragraph>
      <br />
      <Heading>Routing</Heading>
      <Paragraph>
        The routing in this application is handled by React Router, which is the
